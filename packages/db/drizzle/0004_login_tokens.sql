CREATE TABLE "login_tokens" (
	...
	CONSTRAINT "login_tokens_token_digest_unique" UNIQUE("token_digest")
);
...
CREATE INDEX "login_tokens_user_id_idx" ON "login_tokens" USING btree ("user_id");--> statement-breakpoint
