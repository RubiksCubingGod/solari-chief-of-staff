...
- Shared-checkout state: b9 runs six bare re-earns after my message; the 55432 server (C:/tmp/cos-testpg) wants postgres://postgres:nahtest@127.0.0.1:55432/postgres; this session's gates used its private trust-only server on 55434 (C:/tmp/cos-testpg-s9, PID 6356), left running at suspension in case b9 wants it (stop with `pg_ctl -D C:/tmp/cos-testpg-s9 stop`).
